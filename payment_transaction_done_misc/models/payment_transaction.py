            ...
            if self.acquirer_id.done_sale_order_customer_mail_template_id:
                for sale_order_id in self.sale_order_ids:
                    ...
                    if sale_order_id.user_id:
                        mcm_obj = self.env['mail.compose.message'].sudo(sale_order_id.user_id.id).create({})
                    else:
                    ...
                    mcm_obj.template_id = self.acquirer_id.done_sale_order_customer_mail_template_id.id

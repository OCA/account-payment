...
setuptools.setup(
    ...
    install_requires=[
        ...
        'odoo13-addon-account_payment_term_restriction',
        'odoo13-addon-account_payment_term_restriction_purchase',
        'odoo13-addon-account_payment_term_restriction_sale',
        'odoo13-addon-account_payment_term_security',
        'odoo13-addon-partner_aging',
        'odoo13-addon-partner_restrict_payment_acquirer',

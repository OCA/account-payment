...
""",
    ...
    'data': [
        'model/account_account_view.xml',
        'model/account_tax_code_view.xml',
        'model/account_journal_view.xml',
        'model/account_invoice_view.xml',
        'model/account_move_line_view.xml',
        'model/account_voucher_view.xml',
        'model/account_config_settings_view.xml',
        'model/account_fiscal_position_view.xml',
    ],
    'demo': [

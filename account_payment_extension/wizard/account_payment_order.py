...
class PaymentOrderCreate(orm.TransientModel):
    ...
    def search_entries(self, cr, uid, ids, context=None):
        ...
        if payment.mode:
            domain.append(('payment_type', '=', payment.mode.type.id))
        ...
        if amount > 0.0:
            ...
            for line in self.pool['account.move.line'].browse(cr, uid, line_ids,
                                                              context):
        ...
        for line in line_obj.browse(cr, uid, line_ids, context=context):
            ...
            payment_obj.create(
                ...
                {'move_line_id': line.id,
                 ...
                 'communication': ((line.ref and line.name != '/' and line.ref +
                 ...
                 'currency': (line.invoice and line.invoice.currency_id.id or
                              False),
                 'account_id': line.account_id.id}, context=context)
        return {'type': 'ir.actions.act_window_close'}

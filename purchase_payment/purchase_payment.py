...
class purchase_order(osv.osv):
    ...
    _columns = {
        'payment_term': fields.many2one(
            ...
            help='The payment terms. They will be transferred to the '
                 'invoice.'),
        'payment_type': fields.many2one(
            'payment.type', 'Payment type',
            help='The type of payment. It will be transferred to the '
                 'invoice.'),
        ...
        if payment_term != partner_payment_term_id:
            if partner_payment_term_id:
                to_update = self.onchange_payment_term_date_invoice(
                    cr, uid, ids, partner_payment_term_id, date_invoice)

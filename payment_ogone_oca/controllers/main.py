...
class OgoneController(http.Controller):
    ...
    ]  # Facilitates the migration of users who registered the URLs in Ogone's backend
    # prior to 14.3
    ...
    def ogone_return_from_checkout(self, **raw_data):
        ...
        This route can also accept S2S notifications from Ogone if it is configured
        as a webhook in Ogone's backend.
    ...
    def _normalize_data_keys(data):
        ...
        The keys received from Ogone APIs have inconsistent formatting and
    ...
    def _verify_notification_signature(notification_data, received_signature, tx_sudo):
        ...
        :param recordset tx_sudo: The sudoed transaction referenced by the notification
                                  data, as a `payment.transaction` record
        :return: None

...
from odoo.addons.payment_ogone_oca.controllers.main import OgoneController
from odoo.addons.payment_ogone_oca.tests.common import OgoneCommon
...
class OgoneTest(OgoneCommon, PaymentHttpCommon):
    ...
    @mute_logger("odoo.addons.payment_ogone_oca.controllers.main")
    def test_webhook_notification_confirms_transaction(self):
        """Test the processing of a webhook notification."""
        tx = self._create_transaction("redirect")
        url = self._build_url(OgoneController._return_url)
        with patch(
            "odoo.addons.payment_ogone_oca.controllers.main.OgoneController"

...
class AccountPayment(models.Model):
    ...
    def _unlink_except_posted_internal_transfer(self):
    ...
    def button_open_paired_payment(self):
        self.ensure_one()
        return {
            "name": self.env._("Paired Payment"),
    ...
    def _prepare_paired_internal_transfer_values(self):
        ...
        return {
            ...
            "memo": self.memo or self.env._("Internal Transfer"),
    ...
    def _prepare_move_line_default_vals(
        ...
        if self.is_internal_transfer and line_vals_list:
            if self.payment_type == "outbound":
                liquidity_line_name = self.env._(
            ...
            if len(line_vals_list) > 1:
                line_vals_list[1]["name"] = self.env._("Internal Transfer")
